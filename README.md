...
Take the public input of each chain, the aggregation vkey and the aggregation proof, and call `verifyMultiplePessimisticProofs`.


```
cast send \
  $PP_VERIFIER \
  "verifyMultiplePessimisticProofs(bytes32,bytes[],bytes)" \
